...
router.post('/', authenticateToken, async (req, res) => {
  try {
    ...
    const result = await pool.query(
      'INSERT INTO bookings (user_id, service_id, booking_date, booking_time, status) VALUES ($1, $2, $3, $4, $5) RETURNING *',
      [user_id, service_id, booking_date, booking_time, 'pending']
    );
